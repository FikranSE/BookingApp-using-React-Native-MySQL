  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        {/* Main Content */}
        <div className="p-4 sm:p-6 lg:p-8 flex-1 bg-gray-50">
              ...
              {isEditing ? (
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-5">
                    ...
                    {formData.password && (
                      <div className="bg-amber-50 p-3 rounded-lg border border-amber-100 flex items-start mt-2">
                    ...
                    <div className="flex-1 w-full">
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-base font-medium text-gray-900">{profile.username || 'Tidak tersedia'}</p>
                        </div>
                        ...
                        <div>
                          ...
                          <p className="text-base font-medium text-gray-900">{profile.email || 'Tidak tersedia'}</p>
                        </div>
                      </div>
                    </div>
                  </div>
