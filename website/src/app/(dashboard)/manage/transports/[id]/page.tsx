                ...
                <div className="p-6">
                  ...
                  <div className="flex items-start mb-6 p-4 bg-sky-50 rounded-2xl">
                    ...
                    <div className="ml-4 flex-grow">
                      <h3 className="uppercase text-xs font-semibold text-sky-500 tracking-wider">Driver</h3>
                      {isEditing ? (
                        <input
                          type="text"
                          name="driver_name"
            ...
            <div className="md:col-span-5 lg:col-span-4">
              ...
              <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-sky-100 mb-6">
                <div className="p-6 border-b border-sky-100">
                  <h3 className="font-bold text-sky-800">Transport Details</h3>
                </div>
                <div className="p-6">
                  <ul className="space-y-4">
                    <li className="flex justify-between items-center py-2 border-b border-dashed border-sky-100">
                      ...
                      <span className="font-medium text-sky-800">#{transport.transport_id}</span>
                    </li>
                    <li className="flex justify-between items-center py-2 border-b border-dashed border-sky-100">
                      <span className="text-gray-500">Vehicle Name</span>
                      <span className="font-medium text-sky-800">{transport.vehicle_name}</span>
                    </li>
                    <li className="flex justify-between items-center py-2 border-b border-dashed border-sky-100">
                      <span className="text-gray-500">Driver</span>
                      <span className="font-medium text-sky-800">{transport.driver_name || "Not assigned"}</span>
                    </li>
                    <li className="flex justify-between items-center py-2 border-b border-dashed border-sky-100">
                      <span className="text-gray-500">Capacity</span>
                      <span className="font-medium text-sky-800">{transport.capacity} persons</span>
                    </li>
                    <li className="flex justify-between items-center py-2 border-b border-dashed border-sky-100">
                      <span className="text-gray-500">Created</span>
                      <span className="font-medium text-sky-800">{formatDate(transport.createdAt)}</span>
                    </li>
                    <li className="flex justify-between items-center py-2">
                      <span className="text-gray-500">Last Updated</span>
                      <span className="font-medium text-sky-800">{formatDate(transport.updatedAt)}</span>
                    </li>
                  </ul>
                </div>
              </div>
