...
const RoomBookingService_1 = __importDefault(require("../services/RoomBookingService"));
class RoomBookingController {
    static createBooking(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const booking = yield RoomBookingService_1.default.createBooking(Object.assign(Object.assign({}, req.body), { user_id: req.user.id }));
    ...
    static getAllBookings(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const bookings = yield RoomBookingService_1.default.getAllBookings();
    ...
    static getBookingById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const booking = yield RoomBookingService_1.default.getBookingById(Number(req.params.id));
                if (booking) {
    ...
    static updateBooking(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const updatedBooking = yield RoomBookingService_1.default.updateBooking(bookingId, updateData);
                if (updatedBooking) {
                    // Get the user's email
                    let userEmail = yield RoomBookingService_1.default.getUserEmailByBookingId(bookingId);
                    ...
                    if (userEmail) {
                        ...
                        const emailResult = yield RoomBookingService_1.default.sendEmail(userEmail, subject, body);
    ...
    static deleteBooking(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const deleted = yield RoomBookingService_1.default.deleteBooking(Number(req.params.id));
                if (deleted) {
