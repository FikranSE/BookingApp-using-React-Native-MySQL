...
class RoomBookingService {
    static createBooking(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return models_1.RoomBooking.create(data);
        });
    }
    static getAllBookings() {
        return __awaiter(this, void 0, void 0, function* () {
            return models_1.RoomBooking.findAll({
                include: [{
                        model: models_1.User,
                        as: 'user',
                        attributes: ['email']
    ...
    static getBookingById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return models_1.RoomBooking.findByPk(id, {
                include: [{
                        model: models_1.User,
                        as: 'user',
                        attributes: ['email']
    ...
    static updateBooking(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const [affectedCount] = yield models_1.RoomBooking.update(data, {
                where: { booking_id: id },
            });
            if (affectedCount > 0) {
                const updatedBooking = yield models_1.RoomBooking.findByPk(id);
    ...
    static deleteBooking(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return models_1.RoomBooking.destroy({ where: { booking_id: id } });
        });
    }
    static getUserEmailByBookingId(bookingId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const booking = yield models_1.RoomBooking.findOne({
